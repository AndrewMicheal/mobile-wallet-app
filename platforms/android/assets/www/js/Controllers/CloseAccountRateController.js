let CloseAccountRateController = angular.module('starter');

CloseAccountRateController.config(function($translateProvider) {
...
CloseAccountRateController.controller('CloseAccountRateController' , function($scope , $state, $translate,languageService,$rootScope) {
  ...
  $scope.submit = function() {
    $state.go('close-account-home-model')
  }
})
