let PinCodeController = angular.module('starter');

PinCodeController.config(function($translateProvider) {
...
PinCodeController.controller('PinCodeController',function($scope , $ionicPopover ,  $rootScope , $state , $window , languageService , $translate) {
