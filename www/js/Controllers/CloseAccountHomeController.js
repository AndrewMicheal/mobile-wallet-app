let CloseAccountHomeController = angular.module('starter');

CloseAccountHomeController.config(function($translateProvider) {
  $translateProvider.translations('en', {
    ...
    English : "English" ,
    arabic : "Arabic",
    ClosureProcessIsUnderway : "Closure process is underway",
    OK : "OK"
  });
  ...
  $translateProvider.translations('ar', {
    ...
    English : "الإنجليزية",
    arabic : "العربية",
    ClosureProcessIsUnderway : "عملية الإغلاق قيد التنفيذ",
    OK : "موافق"
  });
})

CloseAccountHomeController.controller('CloseAccountHomeController', function($scope , $state,languageService,$translate,$rootScope,$ionicPopover) {
